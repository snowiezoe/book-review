...
$query = "SELECT * FROM books WHERE id = $id AND user_id = {$_SESSION['user_id']}";
$result = mysqli_query($conn, $query);
$book = mysqli_fetch_assoc($result);

if (!$book) {
    die("Buku tidak ditemukan atau Anda tidak memiliki akses!");
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (mysqli_query($conn, $query)) {
        ...
        $error = "Gagal update buku : " . mysqli_error($conn);
    }
}
?>
...
<body>
    <div class="container">
        ...
        <div class="card" style="padding: 35px; max-width: 600px; margin: 0 auto;">
            <h2 class="section-title">✏️ Edit Buku</h2>
            ...
            <form action="" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea name="synopsis" rows="5" required><?= htmlspecialchars($book['synopsis']) ?></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="cover" value="<?= htmlspecialchars($book['cover']) ?>">
                </div>
